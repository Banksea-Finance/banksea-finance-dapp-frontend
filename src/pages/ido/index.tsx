...
import { Card, Flex, Tabs, Text, useResponsive } from '@banksea-finance/ui-kit'
...
const BNTimeDataItem: React.FC<{ label: string; time?: BN }> = ({ label, time }) => {
  ...
  return (
    <Flex ai={'center'} flexDirection={'column'}>
  ...
  return (
    <DefaultPageContainer>
      ...
      >
        ...
        <Flex jc={'space-between'} style={{ width: '80%', margin: '32px 0 32px 10%' }}>
